...
<body>
    <div id="Cover" class="text-center">
        ...
        <p id="indexTitle">
            <font id="ourName">Tea Your Life</font><br><br>
            <font>Welcome ★ Tea Your Dream</font>
        </p>
    </div>
    <div class=" container-fluid" style="background-color: #9f7833;padding: 55px;">
        <div id="buttom" class="row">
            <div class="col-sm-3"></div>
            <div class="col-sm-6">
                學 校　:　國 立 雲 林 科 技 大 學<Br>
                系 別　:　資 訊 工 程 系<br>
                班 級　:　四 資 工 二 A<br>
                成 員　:　B10817035 洪子涵 | B10817004 江季倫 | B10817042 姚佳成<br>
            </div>
            <div class="col-sm-3"></div>
        </div>
    </div>
